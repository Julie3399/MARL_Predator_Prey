...
save_dir = 'DDPG_DDPG_models-SINGLE-ENS-3-1' # 'DDPG_DDPG_models_4_2_rewards(Far)'
...
ddpg_agent_prey_0 = DDPG(obs_dim=env.observation_space("prey_0").shape[0], act_dim=env.action_space("prey_0").n, hidden_size=128, seed=3)
...
# Initialize wandb
wandb.init(project='Evaluate_Final_3_1', name='DDPG_DDPG_3_1_SINGLE_ENS')
