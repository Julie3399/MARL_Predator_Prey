...
from multiagent.utils.conversions import parallel_to_aec
...
# load_ddpg(ddpg_agent_predator_0, 'ddpg_agent_predator_4', save_dir)
# load_ddpg(ddpg_agent_predator_1, 'ddpg_agent_predator_5', save_dir)
# load_ddpg(ddpg_agent_predator_2, 'ddpg_agent_predator_6', save_dir)
# load_ddpg(ddpg_agent_prey_0, 'ddpg_agent0', save_dir)
load_ddpg(ddpg_agent_prey_0, 'ddpg_agent_prey_0', save_dir)
# load_ddpg(ddpg_agent_prey_1, 'ddpg_agent1', save_dir)

# Initialize wandb
wandb.init(project='Evaluate_Predator_3_Prey_1', name='DDPG_DDPG_3_1_rewards_test_SINGLE_SINGLE')

# Set a folder to save the gifs
# gif_dir = 'MADDPG_gifs_DD_DD_3_1_far_RS'
...
def evaluate_model(num_episodes):
    ...
    for episode in tqdm(range(num_episodes), desc="Evaluating Episodes"):
        ...
        mean_predator_reward = sum(agent_rewards['predator']) / len(agent_rewards['predator']) if agent_rewards[
            'predator'] else 0
