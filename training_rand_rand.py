...
maddpg_agent = MADDPG(obs_dim=env.observation_space("predator_0").shape[0], act_dim=env.action_space("predator_0").n,
                      num_predators=4, hidden_size=128, seed=10)
ddpg_agent = DDPG(obs_dim=env.observation_space("prey_0").shape[0], act_dim=env.action_space("prey_0").n,
...
# Initialize wandb
wandb.init(project='Predator_4_Prey_2', name='RAND_RAND_4_2')
...
save_dir = 'RAND_RAND_models_4_2'  # Make sure this directory exists or create it
...
for episode in tqdm(range(NUM_EPISODES), desc="Training Episodes"):
    ...
    wandb.log({
        ...
        "MADDPG Policy Loss (Predator 3)": maddpg_losses[3] if maddpg_losses and maddpg_losses[3] is not None else None,
