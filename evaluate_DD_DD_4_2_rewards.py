...
save_dir = 'DDPG_DDPG_models_4_2_rewards(Far)' # 'DDPG_DDPG_models_4_2_rewards(Far)'
...
# Initialize wandb
wandb.init(project='Evaluate_DD_DD_4_2_rewards', name='DDPG_DDPG_4_2_rewards_benchmark_test(Far)_no_shape')

# Set a folder to save the gifs
gif_dir = 'MADDPG_gifs_DD_DD_4_2_far_ns'
