...
# ddpg_agent1 = DDPG(obs_dim=env.observation_space("predator_0").shape[0], act_dim=env.action_space("predator_0").n,
#                    hidden_size=128, seed=20)
...
# Initialize wandb
wandb.init(project='Predator_3_Prey_1', name='DDPG-DDPG-SINGLE-ENS-3-1')
...
save_dir = 'DDPG_DDPG_models-SINGLE-ENS-3-1'  # Make sure this directory exists or create it
